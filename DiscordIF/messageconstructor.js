...
class MessageConstructor {	
	static buildMessage(stat, player)
	{
		...
		var string_post = "";
		string_post += "You rolled the stat " + stat + " this stat roll corresponds to an ability modifier of " 
				...
				case "dex":
					...
					switch(ability_modifier) {
						case -4:
							...
							break;
						case -3:
							string_post += "With a -3 in dexterity you are a bit of a klutz. Those who travel with you are worried you will spill the rations and stomp out the nightly campfire.\n\n";
							break;
						case -2:
							string_post += "With a -2 in dexterity you are . .\n\n";
							break;
						case -1:
							string_post += "With a -1 in dexterity you are . .\n\n";
							break;
						case 0:
							string_post += "With a +0 in dexterity you are . .\n\n";
							break;
						case 1:
							string_post += "With a +1 in dexterity you are . .\n\n";
							break;
						case 2:
							...
							break;
						case 3:
							string_post += "With a +3 in dexterity you are . .\n\n";
							break;
						case 4:
							string_post += "With a +4 in dexterity you are incredibly nimble. Your ability to move exceeds most that you are associated with. Your speed is stunning in the way of battle.\n\n";
							break;
						default:
							console.log("This shouldn't be possible. Stat: " + stat);
							break;
					...
					break;
				case "con":
					string_post += ":three:: Constitution\n";
					switch(ability_modifier) {
						case -4:
							string_post += "With a -4 in constitution you are . .\n\n";
							break;
						case -3:
							string_post += "With a -3 in constitution you are . .\n\n";
							break;
						case -2:
							string_post += "With a -2 in constitution you are . .\n\n";
							break;
						case -1:
							string_post += "With a -1 in constitution you are . .\n\n";
							break;
						case 0:
							string_post += "With a +0 in constitution you are . .\n\n";
							break;
						case 1:
							string_post += "With a +1 in constitution you are . .\n\n";
							break;
				...
				case "int":
					...
					switch(ability_modifier) {
						case -4:
							...
							break;
						case -3:
							string_post += "With a -3 in intelligence you are . .\n\n";
							break;
						case -2:
							string_post += "With a -2 in intelligence you are . .\n\n";
							break;
						case -1:
							string_post += "With a -1 in intelligence you are . .\n\n";
							break;
						case 0:
							string_post += "With a +0 in intelligence you are . .\n\n";
							break;
						case 1:
							string_post += "With a +1 in intelligence you are . .\n\n";
							break;
						...
						case 3:
							...
							break;
						case 4:
							string_post += "With a +4 in intelligence you are . .\n\n";
							break;
						default:
							console.log("This shouldn't be possible. Stat: " + stat);
							break;
					...
					break;
				case "wis":
					string_post += ":five:: Wisdom\n";
					switch(ability_modifier) {
						case -4:
							string_post += "With a -4 in wisdom you are . .\n\n";
							break;
						case -3:
							string_post += "With a -3 in wisdom you are . .\n\n";
							break;
						case -2:
							string_post += "With a -2 in wisdom you are . .\n\n";
							break;
						case -1:
							string_post += "With a -1 in wisdom you are . .\n\n";
							break;
						case 0:
							string_post += "With a +0 in wisdom you are . .\n\n";
							break;
						case 1:
							string_post += "With a +1 in wisdom you are . .\n\n";
							break;
					...
					break;
				case "cha":
					string_post += ":six:: Charisma\n";
					switch(ability_modifier) {
						case -4:
							string_post += "With a -4 in charisma you are . .\n\n";
							break;
						case -3:
							string_post += "With a -3 in charisma you are . .\n\n";
							break;
						case -2:
							string_post += "With a -2 in charisma you are . .\n\n";
							break;
						case -1:
							string_post += "With a -1 in charisma you are . .\n\n";
							break;
						case 0:
							string_post += "With a +0 in charisma you are . .\n\n";
							break;
						case 1:
							string_post += "With a +1 in charisma you are . .\n\n";
							break;
